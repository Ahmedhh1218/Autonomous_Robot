...
class MPU:
    def __init__(self, gyro, acc, tau):
        ...
        # ROS Publisher
        rospy.init_node('mpu_publisher', anonymous=True)
        self.heading_publisher = rospy.Publisher('heading', Float32, queue_size=10)
    ...
    def compFilter(self):
        ...
        # Publish heading
        self.heading_publisher.publish(self.yaw)
